...
**Desenvolvedora Back-end Python | Estudante de Ciência da Computação**

Movida pela curiosidade e por transformar problemas complexos em soluções eficientes. Atualmente, aplico meus conhecimentos no desenvolvimento de software como Estagiária na LANX e continuo minha jornada acadêmica na UNIP.

Minha base é focada no desenvolvimento Back-end (com um carinho especial por Python e Java Spring Boot), mas também me aventuro pelo front-end quando o projeto pede. Nos momentos de estudo, estou sempre explorando o mundo de Cloud, Redes e boas práticas de código. Adoro um bom desafio e valorizo muito o trabalho em equipe!
